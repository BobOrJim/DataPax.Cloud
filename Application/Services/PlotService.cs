...
namespace Application
{
    public class PlotService
    {
        ...
        public void ResetPlot()
        {
            ...
            {
                Debug.WriteLine($"Exception in PlotService : ResetPlot: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in PlotService : ResetPlot: ex.StackTrace = " + ex.StackTrace);
            }
        }

        public List<Coordinate> CreateCoordinateList(List<XYValuePair> XYValuePairsList, Int64 StartTime, Int64 StopTime) //Bygg Överlagrad när det kommer till integers. Integers utgår tillsvidare. Docker mm går före i kön.
        {
            ...
            {
                Debug.WriteLine($"Exception in PlotService : CreateCoordinateList: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in PlotService : CreateCoordinateList: ex.StackTrace = " + ex.StackTrace);
            }
            return coordinates;
        }
        ...
        public void InsertImageInImageAt(string ImagePathCopyFrom, string ImagePathPasteTo, int XCord, int YCord)
        {
            ...
            {
                Debug.WriteLine($"Exception in PlotService : InsertImageInImageAt: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in PlotService : InsertImageInImageAt: ex.StackTrace = " + ex.StackTrace);
            }
        }
        ...
        public void PlotXAxisTo(Int64 FirstLocationTime, Int64 SecondLocationTime, Int64 ThirdLocationTime, string ImagePathPasteTo)
        {
            ...
            {
                Debug.WriteLine($"Exception in PlotService : PlotXAxisTo: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in PlotService : PlotXAxisTo: ex.StackTrace = " + ex.StackTrace);
            }
        }
        ...
        private string UnixToSolarTimeString(Int64 UnixTime)
        {
            ...
            return result.ToString() + " " + MillisecondString; // result.Millisecond, ovan löser felet med att 45milisekunder blir 450 milisekunder.
        }
        ...
        public void PlotGraphToWithLabel(List<Coordinate> coordinates, string ImagePathPasteTo, int slot, string PlotLabel)
        {
            ...
            {
                Debug.WriteLine($"Exception in PlotService : PlotGraphToWithLabel: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in PlotService : PlotGraphToWithLabel: ex.StackTrace = " + ex.StackTrace);
            }
